...
/*   Updated: 2025/03/06 15:08:20 by leaugust         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Libère la mémoire allouée à une liste chaînée de tokens (t_token).

1. Parcourt la liste en stockant temporairement chaque nœud.
2. Libère son contenu (input).
3. Le désalloue.
3. Répète ce processus jusqu'à ce que tous les tokens soient libérés.
*/
